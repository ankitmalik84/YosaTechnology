  ...
  return (
    <div className="medical-cover">
      <div className="medical-head">
        <h1
          className="medical-heading font-bold text-gradient text-[42px]"
          data-aos="zoom"
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          We are one of the leading billing outsourcing company offering high
          quality services to our clients. Our current information Databases
          helps us perform greater in-depth analysis and research, which in turn
          translate to accuracy and reliability in medical claims management. We
          have experience with most of the popular billing software
          applications.
        </p>
        <br />
        <p>
          We use HIPAA compliant VPN (Virtual Private Networks) to access your
          systems. Our staff will perform the billing functions on your systems,
          exactly the way they used to be done, the only difference being that
          they would be physically in our facility. This means that all your
          processes and reports remain exactly the same.
        </p>
      </div>
      <div
      ...
      >
        ...
        <div
          ...
          data-aos-easing="ease-in-out"
        >
          <h2 className="font-semibold text-[24px]">Demographics & Charges</h2>
          <p>
          ...
          <br />
          <h2 className="font-semibold">Payment Posting</h2>
          <p>
      ...
      <div className="medical-third">
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          We streamline billing process for inpatient & outpatient medical
          practitioners, doctors, & healthcare insurance companies
        </p>
        <br />
        <p
          data-aos="zoom"
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          Outsourcing billing and coding to skilled offshore service providers
          like Outsource2india can help you avail all the above-mentioned
          ...
          your current operating costs by at least 40%. Our end-to-end billing
          and coding solutions can meet all your needs, from following up on
          pending medical claims, to getting reasons for denied claims, tracking
          receivable balances, or initiating collections.
        </p>
        <br />
        <h2
          className="font-semibold"
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          Having been in the billing and coding industry for almost two decades
          now, we have the required experience and expertise to cater to any of
          the client’s needs. We offer an entire gamut of billing and coding
      ...
      <div className="medical-fourth">
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          Our billing services range across a variety of healthcare specialties
        ...
        <div className="medical-fourth-table">
          ...
          >
            <ul className="font-semibold">
              ...
              <li
                ...
                data-aos-easing="ease-in-out"
              >
                <h3>Radiology billing Services</h3>
              </li>
              <li
                data-aos="zoom"
                data-aos-duration="500"
                data-aos-easing="ease-in-out"
              >
                <h3>Cardiology billing Services </h3>
              </li>
              <li
                data-aos="zoom"
                data-aos-duration="500"
              ...
              <li
                ...
                data-aos-easing="ease-in-out"
              >
                <h3>Neurology billing Services</h3>
              </li>
            </ul>
          </div>
          <div className="medical-fourth-table-right">
            ...
            >
              ...
              <li>
                <h3>Orthopedic billing Services</h3>
              </li>
              <li>
      ...
      >
        ...
        <h2
          ...
          data-aos-easing="ease-in-out"
        >
          Tools Leveraged for billing and Coding Services
        </h2>
        <p
          data-aos="zoom"
          data-aos-duration="500"
          data-aos-easing="ease-in-out"
        >
          Being one of the leading providers of billing and coding services, we
          believe in providing our clients with the best quality services within
          a quick time. This is made possible by making use of the best and the
          latest billing and coding tools and technologies. Some of the key
          tools and technologies leveraged by our team include –
        </p>
        <br />
        <h3
          data-aos="zoom"
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          Our skilled billing and coding experts are proficient with –
        </p>
        <ul
          data-aos="zoom"
          data-aos-duration="500"
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          For the past 07 years, we have provided customized billing and coding
          services to varied types of medical facilities. Our customers include
          –
        </p>
        <ul
          data-aos="zoom"
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          As your partner in billing and coding, we can customize our services
          according to the unique requirements of your healthcare facility.
        </p>
        <br />
        <p>
          Read our article on top 8 billing and coding errors you should avoid.
        </p>
        <br />
        <h2
          className="font-semibold"
          ...
          data-aos-easing="ease-in-out"
        >
          Why Choose Clinics4Health for billing & Coding Services?
        </h2>
        <p>
          Outsourcing billing and coding services to Clincs4Health can give you
          access to a series of benefits which you can take advantage of. Some
          of the key reasons for you to choose us include –
        </p>
        <ul
          data-aos="zoom"
          data-aos-duration="500"
        ...
        >
          ...
          <li>
            <h3
              ...
              className="font-semibold"
            >
              billing and Coding for Varied Specialties
            </h3>
          </li>
          <p>
          ...
          <p>
            Our team of billing and coding experts have the required skills,
            talent, resources, and bandwidth to easily ramp up the billing and
            coding service requirement as and when the client needs it.
          </p>
          <li>
            <h3
              data-aos="zoom"
          ...
          <p>
            When you choose to outsource billing and coding to us, we will
            assign you a dedicated project manager who will be the single point
            of contact. The manager will keep you updated about the latest
      ...
      <div className="medical-sixth">
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          Clinics4Health handled the complete billing process for a large
          billing company based in the US, improving productivity by 32% with
          error rates below 2.5%. We processed 145 files a month with an error
          rate of just 2%.
        </p>
        <h2
          className="font-semibold"
          ...
          data-aos-easing="ease-in-out"
        >
          Outsource billing and Coding Services to Clinics4Health.
        </h2>
        <p
          data-aos="zoom"
          data-aos-duration="500"
          data-aos-easing="ease-in-out"
        >
          Clinics4Health has been a leading provider of billing and coding
          services in India and a plethora of other healthcare BPO services to
          clients around the globe. Our team comprises some of the most talented
          and skilled billing and coding experts who have over 100+ man years of
          experience in the field of billing and coding.
        </p>
        <br />
        <p
          data-aos="zoom"
        ...
        >
          Outsourcing billing and coding to skilled offshore service providers
          like Clincs4Health can help you avail all the above-mentioned benefits
          without any hassles. As our customer, your medical facility can get
          access to quality medical coding and billing, while reducing your
          current operating costs by at least 40%. Our end-to-end billing and
          coding solutions can meet all your needs, from following up on pending
          medical claims, to getting reasons for denied claims, tracking
          receivable balances, or initiating collections.
        </p>
        <br />
        <h2
        ...
        <p
          ...
          data-aos-easing="ease-in-out"
        >
          billing Medical Coding Physician Billing Services Patient Demographic
          Entry Medical Data Entry Services ICD-10 and CPT Coding Indexing
          Medical Records Enrollment and Credentialing Services Physician
          Credentialing Services EMS Billing Services DME Billing Services
          Medical Document Scanning Services Charge Entry Emergency Medicine
          Billing Services Claims Submission Appointment Scheduling
        </p>
      </div>
    </div>
  );
